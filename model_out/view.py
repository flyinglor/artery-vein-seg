...
def visualize_numpy_as_stl(numpy_array, temp_path='./temp/temp.stl'):
...
def visualize_two_numpy(numpy_array_1, numpy_array_2):
    temp_path_1 = './temp/temp_1.stl'
    temp_path_2 = './temp/temp_2.stl'
    # temp_path: we need to save numpy_array as .stl, then load .stl to visualize
    # numpy_array should be binary, like 1 means inside tracheae, 0 means outside tracheae
...
art = np.load("./label/artery/003.npz")
vein = np.load("./label/vein/003.npz")
visualize_two_numpy(art.get("data"), vein.get("data"))
os.system("blender -noaudio --background --python glb_out.py")
#stl_to_glb("./temp/temp_1.stl", "./temp/temp_1.glb")